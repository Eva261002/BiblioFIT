<?php
require_once __DIR__ . '/PROYECTO_BFLOGIN.php';
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <section class="flex-grow flex justify-center items-center bg-gradient-to-r from-blue-500 to-indigo-600">
        <div class="w-full max-w-sm bg-white p-8 rounded-lg shadow-lg">
            ...
            <form action="procesar_recuperacion.php" method="POST">
                ...
                <button type="submit" class="w-full py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Enviar Instrucciones</button>
            </form>
        </div>
    </section>
</body>
