    ...
    <div class="container mx-auto p-8">
     ...
     <div class="flex justify-start mb-6">
        ...
        <div id="estudiante-info" class="hidden bg-white p-4 rounded-lg shadow-md">
            ...
            <button id="registrar-salida" class="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition-colors ml-4">Registrar Salida</button>
        </div>
        ...
        <div id="lista-estudiantes" class="bg-white p-4 rounded-lg shadow-md">
            <table class="min-w-full table-auto">
                ...
                <tbody id="estudiantes-dentro"></tbody>
            </table>
        </div>
    </div>
