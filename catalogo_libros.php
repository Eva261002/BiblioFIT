        ...
        <div class="overflow-x-auto bg-white rounded-lg shadow">
            <table class="min-w-full bg-white">
                ...
                <tbody class="text-gray-600 text-sm font-light">
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100" id="libro-<?php echo $row['id_libro']; ?>">
                        <td class="py-3 px-6 text-left"><?php echo $row['titulo']; ?></td>
                        <td class="py-3 px-6 text-left"><?php echo $row['autor']; ?></td>
                        <td class="py-3 px-6 text-left"><?php echo $row['ejemplar']; ?></td>
